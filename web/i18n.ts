export const English = {
  ...
  'errors.descriptions.not-found':
    'The resource you tried to access does not exist',

  'errors.messages.unauthorized': 'Unauthorized',
  'errors.descriptions.unauthorized-upload':
    'Make sure you used the provided link',
...
export const Swedish = {
  ...
  'errors.descriptions.unauthorized-upload':
    'Kontrollera att du använde den givna länken',
...
export function translationsForLanguage(language: string) {
  if (language === 'sv-se') return Swedish
